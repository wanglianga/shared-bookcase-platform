...
捐赠 (donated)
    │
    ▼
  分级审核 ──shelf──► 可借阅 (available) ◄───┐
    │              ▲                          │
    ├──clean──► 待清洁 (pending_clean)        │
    │              │                          │
    │              └────清洁完成──────────────┘
    │                                         │
    ├──transfer──► 转赠学校 (transferred_school)
    │
    └──reject──► 已拒收 (rejected) ── 居民可查看拒收原因
...
志愿者审核图书时，根据以下四个维度综合评估：
- **图书品相**：完好 / 一般 / 破损
- **内容类型**：文学小说 / 科技科普 / 历史传记 / 儿童读物 / 社会科学 / 艺术设计 / 生活健康 / 教辅教材 / 其他
- **适读年龄**：幼儿 / 儿童 / 青少年 / 成人 / 全年龄段
- **是否缺页**：是 / 否

审核决策分为四类：
| 决策 | 含义 | 后续处理 |
| --- | --- | --- |
| ✅ 上架可借阅 | 品相完好、内容合适 | 直接进入书柜流通 |
| 🧹 待清洁后上架 | 略有污渍，清洁后可用 | 自动生成清洁任务 |
| 🏫 转赠学校 | 内容适合但社区存量较多 | 自动生成转赠学校任务 |
| ❌ 拒收 | 破损严重/内容不适/严重缺页 | 记录拒收原因，反馈给捐赠居民 |
